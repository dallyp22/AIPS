...
`;
        ...
        const shiftPatterns = await prisma_1.prisma.shiftPattern.findMany();
        ...
        // Export SKUs
        const skus = await prisma_1.prisma.sKU.findMany();
        ...
        const scheduleBlocks = await prisma_1.prisma.scheduleBlock.findMany();
        ...
        const competencies = await prisma_1.prisma.operatorCompetency.findMany();
        ...
        // Write to file
        const exportPath = path_1.default.join(process.cwd(), '..', 'production_data.sql');
        fs_1.default.writeFileSync(exportPath, sql);
